...
```{r pressure, echo=FALSE, fig.cap="Image source: Cubankite, Africa Studio, Dean Drobot - Shutterstock.", out.width = '100%'}
...
```{r uk_only_model, layout="l-body-outset"}
...
```{r all_countries_model, layout="l-body-outset"}
