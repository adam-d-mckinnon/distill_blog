...
# test the fit
collect_metrics(last_fit_xgboost_workflow)
...
# test the model
predict(final_model_workflow, promotion_test_tbl[1:20,])
pred_test <- final_model_workflow %>% predict(promotion_test_tbl) %>% 
