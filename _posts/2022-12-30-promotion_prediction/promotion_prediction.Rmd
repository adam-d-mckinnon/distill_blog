...
### 4. Establish the model tuning grid

```{r model_tuning_spec}

# Create the model tuning grid
...
# if available cores is greater than 5 default to 5 as diminishing  returns after this point
# https://www.tmwr.org/resampling.html#parallel 
