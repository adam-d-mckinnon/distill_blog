...
# plotly_build(plot_race(racing_resamples))
...
# 9. Extract the model for further testing
final_fitted_model <- final_xgboost$.workflow[[1]]

# test the model
predict(final_fitted_model, promotion_test_tbl[1:20,])
pred_test <- final_fitted_model %>% predict(promotion_test_tbl) %>% 
